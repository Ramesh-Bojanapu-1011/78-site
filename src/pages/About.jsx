        ...
        <div className="mx-auto max-w-7xl px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className={`space-y-8 ${isDark ? "text-white" : "text-gray-900"}`}>
              <ScrollAnimation animation="slide-up" stagger="scroll-stagger-1">
                <div className="mb-4">
                  <span className="text-sm font-semibold uppercase tracking-wider" style={{ color: '#0A5950' }}>
              ...
              <ScrollAnimation animation="slide-up" stagger="scroll-stagger-2">
                <div className="flex flex-wrap gap-4">
                  <a
                    ...
                    style={{ backgroundColor: '#0A5950' }}
                  >
                    <span>{t('about.wellnessProcess.startButton', 'Start Now')}</span>
                ...
                <div className="grid grid-cols-3 gap-8 pt-8">
                  <div className="text-center">
                    ...
                    <div className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                      {t('about.wellnessProcess.stats.experience.label', 'Years Of Experience')}
                    </div>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <div className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                      {t('about.wellnessProcess.stats.coaching.label', 'Hours Of Coaching')}
                    </div>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <div className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                      {t('about.wellnessProcess.stats.courses.label', 'Completed Courses')}
                    </div>
                  </div>
                </div>
              </ScrollAnimation>
            ...
            <div className="relative">
              <ScrollAnimation animation="fade-in" stagger="scroll-stagger-4">
                <div className="relative rounded-3xl overflow-hidden shadow-2xl">
                  ...
                  <div className={`absolute top-6 right-6 rounded-2xl p-4 shadow-xl backdrop-blur-md ${
                    isDark ? 'bg-white/10 border border-white/20' : 'bg-white/90'
                  }`}>
                    <div className={`text-2xl font-bold mb-1 ${isDark ? 'text-white' : 'text-gray-900'}`}>
                      {t('about.wellnessProcess.badges.peopleHelped.value', '100K+')}
                    </div>
                    <div className={`text-sm ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                      {t('about.wellnessProcess.badges.peopleHelped.label', 'People helped')}
                    </div>
                    <div className="mt-2">
                      <img
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className={`space-y-8 ${isDark ? "text-white" : "text-gray-900"}`}>
              <ScrollAnimation animation="slide-up" stagger="scroll-stagger-2">
                ...
                <h2 className={`text-4xl md:text-5xl font-bold leading-tight ${isDark ? 'text-white' : 'text-black'}`}>
                  {t('about.whyChooseUs.title', 'Personalized Energy For Optimal Health')}
                </h2>
              </ScrollAnimation>
              ...
              <ScrollAnimation animation="slide-up" stagger="scroll-stagger-3">
                <div className="space-y-6 mt-8">
                  {[
                    {
                      text: t('about.whyChooseUs.features.customizedPlan', 'Customized Plan Based On Your Specific Needs')
                    },
                    {
                      text: t('about.whyChooseUs.features.allAspects', 'Considering All Aspects Of Your Health')
                    },
                    {
                      text: t('about.whyChooseUs.features.encouragement', 'Provide The Encouragement And Motivation')
                    },
                    {
                      text: t('about.whyChooseUs.features.measurableOutcomes', 'Helping Achieve Measurable Outcomes')
                    }
                  ].map((feature, index) => (
                    <div 
                      key={index}
                ...
                <div className={`rounded-3xl overflow-hidden shadow-2xl border ${
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6">
                      ...
                      <p className="font-semibold text-sm uppercase tracking-wide" style={{ color: '#0A5950' }}>
                  ...
                  <div className="p-6">
                    <div className="flex justify-center gap-4">
                      <a 
                        ...
                        onMouseLeave={(e) => e.currentTarget.style.backgroundColor = isDark ? 'rgb(31, 41, 55)' : 'rgb(243, 244, 246)'}
                      >
                        <svg className={`w-5 h-5 ${isDark ? 'text-white' : 'text-gray-700'}`} fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <ScrollAnimation animation="slide-up" stagger="scroll-stagger-4">
                <div className="grid md:grid-cols-3 gap-4">
                  {[
                    {
                      icon: <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="currentColor"><path d="M12 2L2 7v10c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V7l-10-5zm0 10.99h7c-.53 4.12-3.28 7.79-7 8.94V12H5V9h7V3.01L19 7v2h-7v3.99z"/></svg>,
                      text: t('about.wellnessExpert.highlights.personalizedPlans', 'Personalized plans tailored to your lifestyle')
                    },
                    {
                      ...
                      text: t('about.wellnessExpert.highlights.dataDriven', 'Data‑driven progress tracking and insights')
                    },
                    {
                      icon: <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="currentColor"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/></svg>,
                      text: t('about.wellnessExpert.highlights.coaching', 'Weekly coaching and accountability')
                    }
                  ].map((item, idx) => (
                    <div 
                      key={idx} 
                      ...
                      onMouseEnter={(e) => e.currentTarget.style.borderColor = '#0A5950'}
                      onMouseLeave={(e) => e.currentTarget.style.borderColor = isDark ? 'rgb(55, 65, 81)' : 'rgb(229, 231, 235)'}
                    >
                      <div 
          ...
          <ScrollAnimation animation="slide-up" stagger="scroll-stagger-1">
            <div className="text-center mb-16">
              ...
              <div className="flex items-center justify-center gap-2 mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" width={32} height={32} viewBox="0 0 32 32" style={{ color: '#0A5950' }}>
                  <path fill="currentColor" d="M16 8a5 5 0 1 0 5 5a5 5 0 0 0-5-5m0 8a3 3 0 1 1 3-3a3.003 3.003 0 0 1-3 3m9 11v-1a7 7 0 0 0-7-7h-4a7 7 0 0 0-7 7v1h2v-1a5 5 0 0 1 5-5h4a5 5 0 0 1 5 5v1Z"/>
                </svg>
                <span className="text-sm font-bold uppercase tracking-wider" style={{ color: '#0A5950' }}>
                  {t('about.ourTeam.badge')}
                </span>
              </div>
              
              {/* Main Heading */}
              <h2 className={`text-4xl md:text-5xl font-extrabold mb-4 leading-tight ${isDark ? 'text-white' : 'text-gray-900'}`}>
                {t('about.ourTeam.headingLine1')}<br />
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="p-8 rounded-2xl transition-all duration-300 hover:scale-105 bg-white/10 backdrop-blur-md border border-white/20">
                ...
                <p className="leading-relaxed text-white/80">
                  {t('about.cta.trustIndicators.certifiedProfessionals.description')}
                </p>
              </div>
