  ...
  return (
    <div className={isDark ? 'bg-gray-900 text-white transition-colors' : 'bg-white text-black transition-colors'}>
      ...
      >
        ...
        Transform your life through powerful Theta Healing meditation and energy work
            </p>
          </ScrollAnimation>
          ...
          <div className="text-center mb-4">
            ...
            <ScrollAnimation animation="fade-in" stagger="scroll-stagger-2">
              <p className={`text-base max-w-4xl mx-auto ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                Transform your mind, body, and spirit through powerful energy healing.
                </p>
              </ScrollAnimation>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
            ...
            <ScrollAnimation animation="fade-in" stagger="scroll-stagger-4">
              <div className="text-center">
                <h3 className="text-xl font-bold mb-6" style={{ color: '#0A5950' }}>BELIEF WORK</h3>
                <div className="mb-6 flex justify-center">
                  <div className="relative w-48 h-48 rounded-full overflow-hidden shadow-xl border-4 border-white">
                    <img src="/images/78S6img1.jpg" alt="Belief Work" className="w-full h-full object-cover" />
                  </div>
                </div>
                <p className={`text-sm leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                  Identify and transform limiting beliefs, negative programs, and subconscious blocks that hold you back from achieving your full potential and living your best life.
                </p>
              </div>
            </ScrollAnimation>
            ...
            <ScrollAnimation animation="fade-in" stagger="scroll-stagger-5">
              <div className="text-center">
                <h3 className="text-xl font-bold mb-6" style={{ color: '#0A5950' }}>THETA MEDITATION</h3>
                <div className="mb-6 flex justify-center">
                  <div className="relative w-48 h-48 rounded-full overflow-hidden shadow-xl border-4 border-white">
                    <img src="/images/78S6img2.jpg" alt="Theta Meditation" className="w-full h-full object-cover" />
                  </div>
                </div>
                <p className={`text-sm leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                  Learn to access the theta brainwave state through guided meditation, connecting with divine energy to facilitate deep healing, intuition, and spiritual awakening.
                </p>
                  </div>
            </ScrollAnimation>
            ...
            <ScrollAnimation animation="fade-in" stagger="scroll-stagger-6">
              <div className="text-center">
                <h3 className="text-xl font-bold mb-6" style={{ color: '#0A5950' }}>ENERGY HEALING</h3>
                <div className="mb-6 flex justify-center">
                  <div className="relative w-48 h-48 rounded-full overflow-hidden shadow-xl border-4 border-white">
                    <img src="/images/78S6img3.jpg" alt="Energy Healing" className="w-full h-full object-cover" />
                  </div>
                </div>
                <p className={`text-sm leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                  Experience powerful energy healing sessions that work on physical, emotional, and spiritual levels to release trauma, restore balance, and promote holistic wellness.
                </p>
                </div>
              </ScrollAnimation>
            ...
            <ScrollAnimation animation="fade-in" stagger="scroll-stagger-7">
              <div className="text-center">
                <h3 className="text-xl font-bold mb-6" style={{ color: '#0A5950' }}>MANIFESTATION</h3>
                <div className="mb-6 flex justify-center">
                  <div className="relative w-48 h-48 rounded-full overflow-hidden shadow-xl border-4 border-white">
                    <img src="/images/78S6img4.jpg" alt="Manifestation Training" className="w-full h-full object-cover" />
                  </div>
                </div>
                <p className={`text-sm leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                  Master manifestation techniques using Theta Healing to co-create your reality, attract abundance, achieve goals, and align with your highest purpose and divine path.
                </p>
              </div>
            </ScrollAnimation>
          </div>
          ...
          <div className="text-center mb-16">
            ...
            <ScrollAnimation animation="fade-in" stagger="scroll-stagger-3">
              <p className={`text-lg max-w-2xl mx-auto ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                Find answers to common questions about Theta Healing and our programs
              </p>
            </ScrollAnimation>
          </div>
            ...
            {[
              {
                ...
                answer: "Theta Healing is a powerful meditation technique that allows you to access the theta brainwave state to facilitate physical, emotional, and spiritual healing. By connecting with the Creator's energy, practitioners can identify and transform limiting beliefs, release negative patterns, and promote deep healing at the quantum level through focused intention and divine energy."
              },
              {
                question: "Do I need prior experience with meditation or energy healing?",
              ...
              },
              {
                ...
                answer: "Registration is simple and convenient. You can book sessions through our website, contact us directly via phone or email, or schedule through our mobile app. We offer both individual sessions and group workshops. You'll receive confirmation, preparation instructions, and session details immediately upon booking."
              },
              {
                question: "What should I expect during a Theta Healing session?",
                answer: "During a session, you'll be guided into a relaxed, meditative state while remaining fully conscious. The practitioner will work with you to identify limiting beliefs or blockages, then facilitate healing and transformation through divine energy. Sessions typically last 60-90 minutes. You may experience deep relaxation, emotional releases, insights, or energetic shifts during and after the session."
              },
              {
                question: "Can Theta Healing help with physical health issues?",
                answer: "Yes! Theta Healing addresses physical, emotional, mental, and spiritual wellness holistically. Many clients experience improvements in various health conditions, pain relief, and accelerated healing. However, Theta Healing complements but does not replace medical treatment. We always recommend consulting with healthcare providers for any medical concerns while using Theta Healing as a supportive modality."
              },
              {
                question: "Are Theta Healing sessions available for groups or online?",
      ...
      <section className="relative py-20 text-gray-900 transition-colors duration-500 overflow-hidden">
        {/* Background Image */}
        <div className="absolute inset-0 z-0 bg-fixed bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('/images/78S6img5.jpg')" }}>
          ...
          <div className="grid lg:grid-cols-[300px,1fr] gap-12 items-start">
            ...
            <ScrollAnimation animation="fade-in" stagger="scroll-stagger-2">
                ...
                <h2 className="text-3xl font-bold text-white leading-tight">
                  What our<br/>Theta Healing<br/>clients say
                </h2>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <ScrollAnimation animation="slide-in-right" stagger="scroll-stagger-2">
              <div className="relative rounded-3xl p-12" style={{ backgroundColor: '#0A5950' }}>
                <h2 className="text-4xl font-serif mb-8 text-white">Theta Healing Benefits</h2>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <p className="text-white leading-relaxed">
                      <strong>Deep Belief Transformation:</strong> Access and reprogram limiting beliefs stored in your subconscious mind at the theta level, releasing patterns that have held you back and replacing them with empowering beliefs that support your highest potential.
                    </p>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <p className="text-white leading-relaxed">
                      <strong>Quantum-Level Healing:</strong> Experience profound healing that works on physical, emotional, mental, and spiritual levels simultaneously. Theta Healing addresses root causes of issues, not just symptoms, creating lasting transformation and wellness.
                    </p>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <p className="text-white leading-relaxed">
                      <strong>Enhanced Manifestation:</strong> Learn to harness the power of theta brainwaves to manifest your desires and co-create your reality. Clear blocks to abundance, attract opportunities, and align with your soul's purpose and divine timing.
                    </p>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <p className="text-white leading-relaxed">
                      <strong>Spiritual Connection & Intuition:</strong> Deepen your connection to the Creator's energy and your higher self. Develop heightened intuition, spiritual awareness, and inner wisdom that guides you toward your most authentic and fulfilling life path.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className={isDark ? 'relative py-24 bg-gray-900' : 'relative py-24 bg-white'}>
        <div className="absolute inset-0 bg-cover bg-center bg-no-repeat bg-fixed" style={{ backgroundImage: `url('/images/78S6CTA.jpg')` }}></div>
        <div className="absolute inset-0 bg-black/50"></div>
