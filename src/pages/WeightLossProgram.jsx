  ...
  return (
    <div className={isDark ? 'bg-gray-900 text-white transition-colors' : 'bg-white text-black transition-colors'}>
          ...
          <div className="text-center mb-4">
            ...
            <ScrollAnimation animation="fade-in" stagger="scroll-stagger-2">
              <p className={`text-base max-w-4xl mx-auto ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                Achieve sustainable weight loss with personalized nutrition, fitness training, and lifestyle coaching designed for your success.
              </p>
            </ScrollAnimation>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
            ...
            <ScrollAnimation animation="fade-in" stagger="scroll-stagger-4">
              <div className="text-center">
                <h3 className="text-xl font-bold mb-6" style={{ color: '#0A5950' }}>PERSONALIZED NUTRITION</h3>
                <div className="mb-6 flex justify-center">
                  <div className="relative w-48 h-48 rounded-full overflow-hidden shadow-xl border-4 border-white">
                    <img src="/images/78S2Im1.jpg" alt="Personalized Nutrition Plans" className="w-full h-full object-cover" />
                  </div>
                </div>
                <p className={`text-sm leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                  Custom meal plans tailored to your body type, lifestyle, and weight loss goals. Our nutritionists create balanced, delicious diets that promote sustainable fat loss while ensuring optimal energy and nutrition.
                </p>
              </div>
            </ScrollAnimation>
            ...
            <ScrollAnimation animation="fade-in" stagger="scroll-stagger-5">
              <div className="text-center">
                <h3 className="text-xl font-bold mb-6" style={{ color: '#0A5950' }}>FITNESS TRAINING</h3>
                <div className="mb-6 flex justify-center">
                  <div className="relative w-48 h-48 rounded-full overflow-hidden shadow-xl border-4 border-white">
                    <img src="/images/63S2.jpg" alt="Fitness Training" className="w-full h-full object-cover" />
                  </div>
                </div>
                <p className={`text-sm leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                  Expert-guided exercise programs combining cardio, strength training, and flexibility workouts. Our certified trainers design personalized routines that maximize calorie burn and build lean muscle for lasting results.
                </p>
              </div>
            </ScrollAnimation>
            ...
            <ScrollAnimation animation="fade-in" stagger="scroll-stagger-6">
              <div className="text-center">
                <h3 className="text-xl font-bold mb-6" style={{ color: '#0A5950' }}>LIFESTYLE COACHING</h3>
                <div className="mb-6 flex justify-center">
                  <div className="relative w-48 h-48 rounded-full overflow-hidden shadow-xl border-4 border-white">
                    <img src="/images/78S2im3.jpg" alt="Lifestyle Coaching" className="w-full h-full object-cover" />
                  </div>
                </div>
                <p className={`text-sm leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                  Behavioral modification and motivation strategies to transform your habits. Our coaches help you overcome emotional eating, manage stress, improve sleep, and develop a positive mindset for long-term success.
                </p>
              </div>
            </ScrollAnimation>
            ...
            <ScrollAnimation animation="fade-in" stagger="scroll-stagger-7">
              <div className="text-center">
                <h3 className="text-xl font-bold mb-6" style={{ color: '#0A5950' }}>METABOLIC ASSESSMENT</h3>
                <div className="mb-6 flex justify-center">
                  <div className="relative w-48 h-48 rounded-full overflow-hidden shadow-xl border-4 border-white">
                    <img src="/images/78S2im4.jpg" alt="Metabolic Assessment" className="w-full h-full object-cover" />
                  </div>
                </div>
                <p className={`text-sm leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                  Comprehensive body composition analysis and metabolic rate testing. Advanced diagnostics help us understand your unique metabolism, identify barriers to weight loss, and optimize your program for maximum effectiveness.
                </p>
              </div>
            </ScrollAnimation>
          </div>
      ...
      <section className={isDark ? 'py-20 bg-black' : 'py-20 bg-white'}>
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="text-center mb-16">
            ...
            <ScrollAnimation animation="fade-in" stagger="scroll-stagger-3">
              <p className={`text-lg max-w-2xl mx-auto ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                Find answers to common questions about our weight loss program and how it can help you achieve your goals
              </p>
            </ScrollAnimation>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              {
                question: "How much weight can I expect to lose with your program?",
                answer: "Weight loss results vary based on individual factors like starting weight, metabolism, and commitment level. On average, participants lose 1-2 pounds per week, which is considered healthy and sustainable. Many clients lose 15-30 pounds in the first 3 months. Our program focuses on sustainable fat loss, not quick fixes, ensuring long-term success and improved overall health."
              },
              {
                question: "What makes your weight loss program different from others?",
                answer: "Our program takes a comprehensive, science-based approach combining personalized nutrition, supervised fitness training, behavioral coaching, and metabolic assessment. Unlike one-size-fits-all diets, we customize every aspect to your unique body, lifestyle, and goals. We provide ongoing support, accountability, and adjustments to ensure sustainable results without extreme restrictions or unrealistic expectations."
              },
              {
                question: "Do I need to follow a strict diet or give up my favorite foods?",
                answer: "No extreme restrictions! We believe in sustainable, balanced eating. Your personalized meal plan includes foods you enjoy while creating a caloric deficit for weight loss. We teach portion control, smart food choices, and how to enjoy treats in moderation. The goal is to develop healthy eating habits you can maintain for life, not temporary deprivation."
              },
              {
                question: "How much time do I need to commit to exercise each week?",
                answer: "We recommend 3-5 workout sessions per week, typically 30-60 minutes each. Your fitness plan is tailored to your current fitness level and schedule. Beginners start with manageable routines that gradually increase in intensity. Our trainers offer flexible options including gym workouts, home exercises, and outdoor activities to fit your lifestyle and preferences."
              },
              {
                question: "Will I gain the weight back after completing the program?",
      ...
      <section className="relative py-20 text-gray-900 transition-colors duration-500 overflow-hidden">
        {/* Background Image */}
        <div className="absolute inset-0 z-0 bg-fixed bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('/images/78S2bg.jpg')" }}>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <ScrollAnimation animation="slide-in-right" stagger="scroll-stagger-2">
              <div className="relative rounded-3xl p-12" style={{ backgroundColor: '#0A5950' }}>
                <h2 className="text-4xl font-serif mb-8 text-white">Weight Loss Program Benefits</h2>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <p className="text-white leading-relaxed">
                      <strong>Improved Health Markers:</strong> Our comprehensive program helps reduce blood pressure, lower cholesterol levels, and improve blood sugar control. Experience significant improvements in cardiovascular health, reduced risk of chronic diseases, and enhanced overall physical wellness.
                    </p>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <p className="text-white leading-relaxed">
                      <strong>Increased Energy & Vitality:</strong> Shed excess weight and feel more energized throughout your day. Proper nutrition and regular exercise boost your metabolism, improve sleep quality, and enhance stamina, allowing you to enjoy life with renewed vigor and enthusiasm.
                    </p>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <p className="text-white leading-relaxed">
                      <strong>Enhanced Mental Well-being:</strong> Weight loss success boosts self-confidence and reduces anxiety and depression. Regular exercise releases endorphins, improving mood and mental clarity, while achieving your goals provides a sense of accomplishment and empowerment.
                    </p>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <p className="text-white leading-relaxed">
                      <strong>Sustainable Lifestyle Changes:</strong> Learn healthy habits that last a lifetime. Our program equips you with knowledge about nutrition, exercise, and behavioral strategies, ensuring you maintain your weight loss and continue thriving long after completing the program.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className={isDark ? 'relative py-24 bg-gray-900' : 'relative py-24 bg-white'}>
        <div className="absolute inset-0 bg-cover bg-center bg-no-repeat bg-fixed" style={{ backgroundImage: `url('/images/78S2CTA.jpg')` }}></div>
        <div className="absolute inset-0 bg-black/50"></div>
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <ScrollAnimation animation="fade-in" stagger="scroll-stagger-2">
            <p className="text-base md:text-lg text-white max-w-2xl mx-auto mb-10">
              Get personalized support and expert guidance to achieve your weight loss goals today.
            </p>
          </ScrollAnimation>
          <ScrollAnimation animation="fade-in" stagger="scroll-stagger-3">
