  ...
  return (
    <div className={isDark ? 'bg-gray-900 text-white transition-colors' : 'bg-white text-black transition-colors'}>
        ...
        <div className="relative z-10 px-6 max-w-4xl">
          ...
          <ScrollAnimation animation="fade-in" stagger="scroll-stagger-2">
            <p className="mt-6 text-base md:text-lg text-gray-200 max-w-2xl mx-auto leading-relaxed whitespace-nowrap">
              Discover how proper nutrition supports mental wellness, reduces stress, and enhances cognitive function
            </p>
          </ScrollAnimation>
          ...
          <div className="text-center mb-4">
            ...
            <ScrollAnimation animation="fade-in" stagger="scroll-stagger-2">
              <p className={`text-base max-w-4xl mx-auto ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                Support brain health, emotional balance, and stress reduction through specialized nutrition strategies.
              </p>
            </ScrollAnimation>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
            ...
            <ScrollAnimation animation="fade-in" stagger="scroll-stagger-4">
              <div className="text-center">
                <h3 className="text-xl font-bold mb-6" style={{ color: '#0A5950' }}>BRAIN-BOOSTING FOODS</h3>
                <div className="mb-6 flex justify-center">
                  <div className="relative w-48 h-48 rounded-full overflow-hidden shadow-xl border-4 border-white">
                    <img src="/images/78S4img1.jpg" alt="Brain-Boosting Foods" className="w-full h-full object-cover" />
                  </div>
                </div>
                <p className={`text-sm leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                  Nutrient-rich foods that enhance cognitive function, memory, and focus. Our plans include omega-3 fatty acids, antioxidants, and vitamins essential for optimal brain health and mental clarity.
                </p>
              </div>
            </ScrollAnimation>
            ...
            <ScrollAnimation animation="fade-in" stagger="scroll-stagger-5">
              <div className="text-center">
                <h3 className="text-xl font-bold mb-6" style={{ color: '#0A5950' }}>MOOD-STABILIZING NUTRITION</h3>
                <div className="mb-6 flex justify-center">
                  <div className="relative w-48 h-48 rounded-full overflow-hidden shadow-xl border-4 border-white">
                    <img src="/images/78S4img2.jpg" alt="Mood-Stabilizing Nutrition" className="w-full h-full object-cover" />
                  </div>
                </div>
                <p className={`text-sm leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                  Balanced meal plans that regulate blood sugar, boost serotonin, and support emotional well-being. Combat anxiety, depression, and mood swings through strategic nutritional choices.
                </p>
              </div>
            </ScrollAnimation>
            ...
            <ScrollAnimation animation="fade-in" stagger="scroll-stagger-6">
              <div className="text-center">
                <h3 className="text-xl font-bold mb-6" style={{ color: '#0A5950' }}>STRESS-REDUCING DIETS</h3>
                <div className="mb-6 flex justify-center">
                  <div className="relative w-48 h-48 rounded-full overflow-hidden shadow-xl border-4 border-white">
                    <img src="/images/78S4img3.jpg" alt="Stress-Reducing Diets" className="w-full h-full object-cover" />
                  </div>
                </div>
                <p className={`text-sm leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                  Anti-inflammatory foods and adaptogens that lower cortisol levels and calm the nervous system. Reduce chronic stress and anxiety through targeted nutrition therapy and mindful eating.
                </p>
              </div>
            </ScrollAnimation>
            ...
            <ScrollAnimation animation="fade-in" stagger="scroll-stagger-7">
              <div className="text-center">
                <h3 className="text-xl font-bold mb-6" style={{ color: '#0A5950' }}>SLEEP & MENTAL RECOVERY</h3>
                <div className="mb-6 flex justify-center">
                  <div className="relative w-48 h-48 rounded-full overflow-hidden shadow-xl border-4 border-white">
                    <img src="/images/78S4img4.jpg" alt="Sleep & Mental Recovery" className="w-full h-full object-cover" />
                  </div>
                </div>
                <p className={`text-sm leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                  Nutrition plans optimized for quality sleep and mental restoration. Foods rich in magnesium, tryptophan, and melatonin precursors help regulate sleep cycles and enhance mental recovery.
                </p>
              </div>
            </ScrollAnimation>
          </div>
          ...
          <div className="text-center mb-16">
            ...
            <ScrollAnimation animation="fade-in" stagger="scroll-stagger-3">
              <p className={`text-lg max-w-2xl mx-auto ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                Discover how food impacts mental health and find answers to your questions about the mind-body connection
              </p>
            </ScrollAnimation>
          </div>
      ...
      <section className="relative py-20 text-gray-900 transition-colors duration-500 overflow-hidden">
        {/* Background Image */}
        <div className="absolute inset-0 z-0 bg-fixed bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('/images/78S4img5.jpg')" }}>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <ScrollAnimation animation="slide-in-right" stagger="scroll-stagger-2">
              <div className="relative rounded-3xl p-12" style={{ backgroundColor: '#0A5950' }}>
                <h2 className="text-4xl font-serif mb-8 text-white">Mental Health Benefits</h2>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <p className="text-white leading-relaxed">
                      <strong>Reduced Anxiety & Stress:</strong> Experience calmer nerves and lower stress levels through foods that regulate cortisol production and support your nervous system. Strategic nutrient timing helps maintain emotional balance throughout challenging days.
                    </p>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <p className="text-white leading-relaxed">
                      <strong>Enhanced Mood & Emotional Stability:</strong> Boost serotonin and dopamine levels naturally through targeted nutrition. Say goodbye to mood swings and hello to consistent emotional well-being with foods that support neurotransmitter production.
                    </p>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <p className="text-white leading-relaxed">
                      <strong>Improved Cognitive Function:</strong> Sharpen your memory, focus, and mental clarity with brain-nourishing foods rich in omega-3s and antioxidants. Combat brain fog and enhance mental processing speed for peak cognitive performance.
                    </p>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <p className="text-white leading-relaxed">
                      <strong>Better Sleep & Mental Recovery:</strong> Achieve restorative sleep through foods that support melatonin production and circadian rhythm regulation. Wake up refreshed with improved mental resilience and emotional regulation for lasting wellness.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className={isDark ? 'relative py-24 bg-gray-900' : 'relative py-24 bg-white'}>
        <div className="absolute inset-0 bg-cover bg-center bg-no-repeat bg-fixed" style={{ backgroundImage: `url('/images/78S4CTA.jpg')` }}></div>
        <div className="absolute inset-0 bg-black/50"></div>
