...
const CATEGORIES = [
  {
    id: "all",
    labelKey: "classesTimetable.categories.all",
    color: "bg-gray-200 text-gray-800",
  },
  {
    id: "dance",
    labelKey: "classesTimetable.categories.dance",
    color: "bg-green-500/10 text-green-600 border border-green-300",
  },
  {
    id: "nutrition",
    labelKey: "classesTimetable.categories.nutrition",
    color: "bg-emerald-500/10 text-emerald-600 border border-emerald-300",
  },
  {
    id: "stretching",
    labelKey: "classesTimetable.categories.stretching",
    color: "bg-orange-500/10 text-orange-600 border border-orange-300",
  },
  {
    id: "workout",
    labelKey: "classesTimetable.categories.workout",
    color: "bg-blue-500/10 text-blue-600 border border-blue-300",
  },
];
...
const SAMPLE_EVENTS = [
  {
    day: "tuesday",
    time: "10:00",
    titleKey: "classesTimetable.classes.zumba",
    coach: "Olivia Hall",
    end: "11:00",
    category: "workout",
    color: "text-rose-500",
  },
  {
    day: "wednesday",
    time: "10:00",
    titleKey: "classesTimetable.classes.powerDance",
    coach: "Shirley Young",
    end: "11:00",
    category: "dance",
...

  {
    day: "monday",
    time: "12:00",
    titleKey: "classesTimetable.classes.pilates",
    coach: "Kimberly Tran",
    end: "13:00",
    category: "stretching",
...

  {
    day: "tuesday",
    time: "14:00",
    titleKey: "classesTimetable.classes.yogaWorkout",
    coach: "Gloria Moore",
    end: "15:00",
    category: "workout",
              ...
              >
                ...
                {DAYS.map((day) => {
                  ...
                  return (
                    <div
                      key={key}
                      className="p-4 min-h-[120px] border-l border-black/10 dark:border-white/10"
                    >
                      {items.map((evt, i) => (
                        <div
                          key={i}
