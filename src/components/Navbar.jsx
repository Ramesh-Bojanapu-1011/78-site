    ...
    >
      <nav className="mx-auto max-w-6xl px-4 py-3 flex items-center justify-between">
        ...
        <ul className="hidden md:flex items-center gap-8">
          ...
          <li>
            <button onClick={() => navigate('/about')} className="hover:text-[#0A5950] dark:hover:text-[#0A5950] transition-colors">
              {t('nav.about')}
            </button>
          </li>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="start" className="w-56">
                ...
                {[
                  ...
                  {label: t('nav.spaTherapies'), path:'/services/weight-loss-program'},
                  {label: t('nav.holisticHealing'), path:'/services/nutrition-counseling'},
                  {label: t('nav.nutritionPlans'), path:'/services/mental-health'},
                  {label: t('nav.mindfulLiving'), path:'/services/ayurvedic-treatment'},
                  {label: t('nav.wellnessEvents'), path:'/services/theta-healing'}
                ].map((item) => (
                  <DropdownMenuItem 
                    key={item.label} 
          ...
          <li>
            <button onClick={() => navigate('/blog')} className="hover:text-[#0A5950] dark:hover:text-[#0A5950] transition-colors">
              {t('nav.blog')}
            </button>
          </li>
          <li>
            <button onClick={() => navigate('/contact')} className="hover:text-[#0A5950] dark:hover:text-[#0A5950] transition-colors">
              {t('nav.contact')}
            </button>
          </li>
        </ul>
