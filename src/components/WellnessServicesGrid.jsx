    ...
    <section id="wellness-grid" className="py-20 bg-gray-50 dark:bg-gray-900">
      <div className="mx-auto max-w-7xl px-4">
        <div className="text-center mb-16">
          <p className="text-sm uppercase tracking-widest font-semibold" style={{ color: '#0A5950' }}>{t(eyebrow)}</p>
          <h2 className="mt-3 text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white">{t(title)}</h2>
          <p className="mt-4 text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">{t(subtitle)}</p>
        </div>
              ...
              <article>
                <div className="relative aspect-[4/3] overflow-hidden">
                  ...
                  <div className="absolute top-6 left-6">
                    <span className="inline-block px-4 py-2 text-white text-sm font-bold rounded-lg shadow-md" style={{ backgroundColor: '#0A5950' }}>
                      {c.tag}
                    </span>
                  </div>
                </div>
