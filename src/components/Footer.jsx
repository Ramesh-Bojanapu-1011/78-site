          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-3">
              {[
                ...
                { name: t('footer.spaTherapies'), path: '/services/weight-loss-program' },
                { name: t('footer.holisticHealing'), path: '/services/nutrition-counseling' },
                { name: t('footer.nutritionPlans'), path: '/services/mental-health' },
                { name: t('footer.mindfulLiving'), path: '/services/ayurvedic-treatment' },
                { name: t('footer.wellnessEvents'), path: '/services/theta-healing' }
              ].map((service) => (
                <li key={service.name}>
                  <button
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <div className={`${isDark ? 'bg-[#0A5950]/20' : 'bg-[#0A5950]/10'} w-5 h-5 rounded-full flex items-center justify-center mt-0.5`}>
                  <svg className={`w-3 h-3 ${isDark ? 'text-[#0A5950]' : 'text-[#0A5950]'}`} fill="currentColor" viewBox="0 0 20 20">
